    ...
    value: function findContours(sourceMat) {
      if (this.useTargetColor) {
        ...
        if (this.trackingColorMode === p5.cv.TrackingColorMode.TRACK_COLOR_RGB) {
          var lowerb = new cv.Mat(this.sourceMat.rows, this.sourceMat.cols, this.sourceMat.type(), cv.Scalar.sub(base, offset));
          var upperb = new cv.Mat(this.sourceMat.rows, this.sourceMat.cols, this.sourceMat.type(), cv.Scalar.add(base, offset));
          ...
          var _lowerb = new cv.Mat(this.sourceMat.rows, this.sourceMat.cols, this.sourceMat.type(), cv.Scalar.sub(base, offset));

          var _upperb = new cv.Mat(this.sourceMat.rows, this.sourceMat.cols, this.sourceMat.type(), cv.Scalar.add(base, offset));
